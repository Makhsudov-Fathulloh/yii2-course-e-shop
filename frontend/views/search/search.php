    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-9 padding-right">
                <!--                --><?php //var_dump($pages); die();?>
                <!--                --><?php //var_dump($category->name); die();?>
                <!--                --><?php //dump($category); die();?>

                <?php if (!empty($products)) : ?>
                <div class="features_items"><!--features_items-->
<!--                    <h2 class="title text-center">Поиск по запросу: --><?php //= $q ?><!--</h2>-->
                    ...
                    <?php else: ?>
                        <h2 class="title text-center">on request <?= \yii\helpers\Html::encode($q) ?></h2>
